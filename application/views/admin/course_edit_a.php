  ...
  <div class="content-wrapper">
    ...
    <section class="content" >
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-12">
            <?php foreach ($course as $coursev) { ?>
            <?php echo validation_errors(); ?>
            <?php echo form_open_multipart('admin/Course/course_edit_do/'.$coursev->course_id); ?>
                ...
                <table class="table table-bordered">
                  <tr>
                    ...
                    <td>
                      <select name="system_id" class="form-control">
                        ...
                        <?php foreach ($systems as $sysv) { ?>
                          <option value="<?php echo $sysv->system_id ?>"
                            <?php echo ($coursev->system_id == $sysv->system_id)? 'selected':''?>>
                            <?php echo $sysv->name ?>
                          </option>
                        <?php } ?>
                      </select>
                  ...
                  <tr>
                    <th> Course Name </th>
                    <td> <input type="text" class="form-control" name="name" value="<?php echo $coursev->name; set_value('name'); ?>"> </td>
                  </tr>
                  <tr>
                    <th> Course Code </th>
                    <td> <input type="text" class="form-control" name="code" value="<?php echo $coursev->code; set_value('code'); ?>"> </td>
                  </tr>
